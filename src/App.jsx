...
const ScheduleLiveDemoForm = () => (
  <form className="space-y-4">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <FormInput label="Business Name" placeholder="Urban Chic Salon" />
    </div>
    <FormInput label="Country & Timezone" placeholder="e.g. UK (GMT/BST)" />
    
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <FormInput label="Preferred Date" type="date" />
      <FormSelect 
        label="Choose Your Preferred Demo Slot (UK Time)" 
        options={[
          "10:00 AM",
          "11:00 AM",
          "1:00 PM",
    ...
    <FormSelect 
      label="Number of Team Members Joining" 
      options={["Just Me", "2", "3–5", "5+"]} 
    />
    
    <FormTextarea label="What should we focus on?" placeholder="E.g., How to manage multiple branches..." />
    
    <button className="w-full bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-bold py-4 rounded-xl hover:shadow-lg hover:shadow-emerald-600/20 transition-all transform hover:-translate-y-1 mt-4">
      👉 Schedule Live Demo
    </button>
  </form>
);
